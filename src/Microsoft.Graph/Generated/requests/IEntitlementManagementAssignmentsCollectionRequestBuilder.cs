...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IEntitlementManagementAssignmentsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEntitlementManagementAssignmentsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEntitlementManagementAssignmentsCollectionRequest Request(IEnumerable<Option> options);
