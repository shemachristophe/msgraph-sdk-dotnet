...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class AccessPackageSubjectReferenceRequest : BaseRequest, IAccessPackageSubjectReferenceRequest
    {
        /// <summary>
        ...
        public AccessPackageSubjectReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AccessPackageSubject reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AccessPackageSubject reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AccessPackageSubject reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
