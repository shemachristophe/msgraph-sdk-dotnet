...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface IEntitlementManagementAssignmentRequestsCollectionRequestBuilder : IBaseRequestBuilder
    {
        /// <summary>
        /// Builds the request.
        /// </summary>
        /// <returns>The built request.</returns>
        IEntitlementManagementAssignmentRequestsCollectionRequest Request();
        ...
        /// <returns>The built request.</returns>
        IEntitlementManagementAssignmentRequestsCollectionRequest Request(IEnumerable<Option> options);
