...
namespace Microsoft.Graph
{
    ...
    public partial class BookingBusinessStaffMembersCollectionRequestBuilder : BaseRequestBuilder, IBookingBusinessStaffMembersCollectionRequestBuilder
    {
        ...
        /// <summary>
        /// Gets an <see cref="IBookingStaffMemberBaseRequestBuilder"/> for the specified BookingBusinessBookingStaffMemberBase.
        /// </summary>
        ...
        public IBookingStaffMemberBaseRequestBuilder this[string id]
        {
            get
            {
                return new BookingStaffMemberBaseRequestBuilder(this.AppendSegmentToRequestUrl(id), this.Client);
            }
        }
