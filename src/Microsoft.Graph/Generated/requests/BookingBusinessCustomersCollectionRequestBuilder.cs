...
namespace Microsoft.Graph
{
    ...
    public partial class BookingBusinessCustomersCollectionRequestBuilder : BaseRequestBuilder, IBookingBusinessCustomersCollectionRequestBuilder
    {
        ...
        /// <summary>
        /// Gets an <see cref="IBookingCustomerBaseRequestBuilder"/> for the specified BookingBusinessBookingCustomerBase.
        /// </summary>
        ...
        public IBookingCustomerBaseRequestBuilder this[string id]
        {
            get
            {
                return new BookingCustomerBaseRequestBuilder(this.AppendSegmentToRequestUrl(id), this.Client);
            }
        }
