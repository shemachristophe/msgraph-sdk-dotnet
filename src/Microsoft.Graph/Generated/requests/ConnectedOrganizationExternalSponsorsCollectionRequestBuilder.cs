...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ConnectedOrganizationExternalSponsorsCollectionRequestBuilder : BaseRequestBuilder, IConnectedOrganizationExternalSponsorsCollectionRequestBuilder
    {
        /// <summary>
        ...
        public ConnectedOrganizationExternalSponsorsCollectionRequestBuilder(
            string requestUrl,
            IBaseClient client)
        ...
        public IConnectedOrganizationExternalSponsorsCollectionRequest Request()
        {
        ...
        /// <returns>The built request.</returns>
        public IConnectedOrganizationExternalSponsorsCollectionRequest Request(IEnumerable<Option> options)
        {
            return new ConnectedOrganizationExternalSponsorsCollectionRequest(this.RequestUrl, this.Client, options);
        }
