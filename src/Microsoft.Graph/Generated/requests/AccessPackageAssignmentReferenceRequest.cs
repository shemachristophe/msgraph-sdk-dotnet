...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class AccessPackageAssignmentReferenceRequest : BaseRequest, IAccessPackageAssignmentReferenceRequest
    {
        /// <summary>
        ...
        public AccessPackageAssignmentReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified AccessPackageAssignment reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified AccessPackageAssignment reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The AccessPackageAssignment reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
